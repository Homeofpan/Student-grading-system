...
<body>
    <div class="panel-body" style="padding-bottom:0px;">
            ...
            <div class="panel-body">
                <form id="formSearch" class="form-horizontal">
                    <div class="form-group" style="margin-top:15px">
                        <label class="control-label col-sm-1" for="txt_search_departmentname">学生姓名</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="stuName">
                        </div>
                        <label class="control-label col-sm-1" for="txt_search_departmentname">学号</label>
                        <div class="col-sm-2">
        ...
        <div id="toolbar" class="btn-group">
            <button id="add-student" type="button" class="btn btn-default">
            ...
            <button id="edit-student" type="button" class="btn btn-default">
