                ...
                <form id="formSearch" class="form-horizontal">
                 	<div class="form-group" style="margin-top:15px">
	                 	<div class="row"><!-- =========================第一行开始================================ -->
	                        ...
	                        <label  class="control-label col-sm-2" for="sno">评分状态:</label>
	                        <div class="col-sm-3">
                    ...
                    <div class="row"><!-- =============================第三行开始================================ -->
	                    ...
	                    <div class="col-sm-7">
	                        <button type="button" style="margin-left:150px" id="clean" class="btn btn-primary pull-right">清空查询条件</button>
	                    </div>
                    </div><!-- ========================================第三行结束================================ -->
