...
<div class="pageContainer">
     ...
     <div class="pageSidebar">
         <ul class="nav nav-stacked nav-pills">
             <li role="presentation">
                 <a href="/outPage/workRecord" target="mainFrame">工作记录</a>
             </li>
             <li role="presentation">
                 <a href="/outPage/showScore" target="mainFrame">评分查询</a>
             </li>
             <li role="presentation">
                 <a href="/outPage/avgScore" target="mainFrame">平均分统计</a>
             </li>
             <!-- 开始 -->
             <li class="dropdown">
                 ...
                 <ul class="dropdown-menu">
                     <li>
                         <a href="/outPage/password_edit" target="mainFrame">修改密码</a>
                     </li>
                     <li>
                         <a href="/outPage/stuManager" target="mainFrame">个人信息</a>
                     </li>
                 </ul>
             </li>
             <!-- 结束 -->
