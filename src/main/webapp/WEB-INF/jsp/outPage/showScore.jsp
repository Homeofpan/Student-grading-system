...
<head>
    ...
    <!-- 5、页面Js文件的引用 -->
    <script src="/js/edit/stushowScore.js"></script>
    <!-- 6、弹出框 -->
            ...
            <div class="panel-body">
                <form id="formSearch" class="form-horizontal">
                    ...
                    <div class="row"><!-- =============================第三行开始================================ -->
                        ...
                        <div class="col-sm-3">
                            <input id="stuname" type="text" class="form-control" value=""/>
                        </div>
                    ...
                    <div class="row"><!-- =============================第四行开始================================ -->
                    	...
                    	<div class="col-sm-3">
                            <input id="sno" type="text" class="form-control" value="" readonly="readonly"/>
                        </div>
